...
#filedict = { "lphy_dump.bin":"lphy_dump.txt"}
#filedict = {"modem_dump.bin" : "modem_dump.txt"}
filedict = {"modem_dump.bin" : "modem_dump.txt", "lphy_dump.bin":"lphy_dump.txt"}
...
base_log_info = ['cpuinfo0.txt','cpuinfo1.txt','PRINT.txt','DMESG.txt','LOG.txt','cpui.txt']
