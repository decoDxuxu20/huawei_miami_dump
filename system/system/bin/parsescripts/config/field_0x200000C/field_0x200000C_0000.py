...
def PrintUserData(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0x200000C PrintUserData")
...
def entry_0x200000C(infile, field, offset, slen, version, mode, outfile, field_list = None):
        try:
            if not field == '0x200000C':
                print('hidis field is ', field)
                print('current field is', '0x200000C')
            ...
            print("got entry 0x200000C")
            outfile.writelines("============USER DATA============\n")
