...
def PrintIntStack(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0x2000004 PrintIntStack")
...
def entry_0x2000004(infile, field, offset, slen, version, mode, outfile):
        try:
            if not field == '0x2000004':
                print('hidis field is ', field)
                print('current field is', '0x2000004')
            ...
            print("got entry 0x2000004")
            #outfile.writelines("============INT STACK============\n")
