...
def PrintOAMData(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0x1200000 PrintOAMData")
...
def entry_0x1200000(infile, field, offset, slen, version, mode, outfile, field_list = None):
        try:
            if not field == '0x1200000':
                print('hidis field is ', field)
                print('current field is', '0x1200000')
                return error['ERR_CHECK_FIELD']
            elif not version == '0x0000':
                print('hidis version is ', version)
                print('current version is ', '0x0000')
                return error['ERR_CHECK_VERSION']
            elif not slen == '0x8000':
                print('hids len is ', slen)
                print('current len is ', '0x8000')
                return error['ERR_CHECK_LEN']
            print("got entry 0x1200000")
            outfile.writelines("============OAM MODEMAP============\n")
