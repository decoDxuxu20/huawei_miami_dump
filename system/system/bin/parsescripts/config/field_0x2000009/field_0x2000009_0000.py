...
def entry_0x2000009(infile, field, offset, slen, version, mode, outfile):
        try:
            if not field == '0x2000009':
                print('hidis field is ', field)
                print('current field is', '0x2000009')
            ...
            print("got entry 0x2000009")
            outfile.writelines("============REGS============\n")
