#######################################################################################################################################
#   filename        :   field_0x220000D_0000.py
#
...
def entry_0x220000D(infile, field, offset, len, version, mode, outfile, field_list = None):
    try:
        if not field == '0x220000D':
            print('hidis field is ', field)
            print('current field is', '0x220000D')
        ...
        outfile.write('***USIM I1 inteactive message***\r\n')
