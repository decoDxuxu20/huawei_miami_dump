...
def PrintUserData(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0x10F000B PrintUserData")
...
def entry_0x10F000B(infile, field, offset, slen, version, mode, outfile, field_list = None):
        try:
            if not field == '0x10F000B':
                print('hidis field is ', field)
                print('current field is', '0x10F000B')
            ...
            print("got entry 0x10F000B")
            outfile.writelines("============MODEMAP USER DATA============\n")
